...
exports.generateStyledEmailTemplate = generateStyledEmailTemplate;
function generateStyledEmailTemplate(firstName, lastName, email, phone, contactingReason, acquisitionChannel, textBox) {
    return `
  <body>
