...
import VideoPlayer from "../components/OnLoadingAnimation/Video";
import CubeCarousel from "../components/Cube/Cube";
import TextAnimation from "../components/Cube/CubeTxt";
                ...
                {(location.pathname === "/" ||
                  ...
                  <>
                    {window.innerWidth < 941 ? (
                      <div
                        className="home-content-container1"
                        style={{ minHeight: "18rem", display: "inline-block" }}
                      >
